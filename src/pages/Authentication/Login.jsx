...
import loginLottieAnimation from '../../assets/login2Lottie.json'
                    ...
                    <form onSubmit={handleSignIn}>
                        ...
                        <div className="mb-6">
                            ...
                            <input
                                ...
                                name="password"
                                className="block w-full px-4 py-2 border rounded-lg text-gray-700 focus:border-blue-400 focus:ring-opacity-40 focus:outline-none focus:ring focus:ring-blue-300"
                                type="password"
                            />
                        </div>
